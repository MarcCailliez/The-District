          ...
          <div class="card rounded-5 border border-secondary" id="tailleAcceuil1">
            <a href="commande.php" class="link-underline link-underline-opacity-0">
              ...
              <div class="card-body rounded-bottom-5 border border-secondary" id="couleurAcceuil1">
                ...
                <p class="card-text text-dark">Un magnifique assostissement de sushis, maki, california ete sashimi à partager ou seul pour les plus gourmand ! </p>
...
<br>
<div id="boutonGauche">
  <a href="Vegetarien.php" class="btn btn-primary btn-lg rounded-5 border border-secondary">Précédent</a>
</div>
<div id="boutonDroite">
  <a href="pasta.php" class="btn btn-primary btn-lg rounded-5 border border-secondary">Next</a>
</div>
<br><br><br>
